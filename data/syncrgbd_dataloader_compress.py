...
class SyncRGBD_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        compressed_lr = gt_depth.astype(np.uint16)
        ...
        compressed_lr = (compressed_lr - gt_depth_min) / (gt_depth_max - gt_depth_min)
        ...
        lr = np.array(Image.fromarray(compressed_lr).resize((w, h), Image.BICUBIC))
