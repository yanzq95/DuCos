...
def main():
    ...
    if args.isNosiy == 0:
        ...
        val_RGBDD = RGBDD_Dataset(root_dir="/opt/data/private/DSR/datasets/RGBDD/", scale=args.scale, downsample='real',train=False)

    else:
        from data.rgbdd_dataloader_Noisy import RGBDD_Dataset
        val_RGBDD = RGBDD_Dataset(root_dir="/opt/data/private/DSR/datasets/RGBDD/", scale=args.scale, downsample='real',
