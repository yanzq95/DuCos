...
parser.add_argument('--data_name', type=str, choices=('NYU', 'KITTIDC', 'IPAD', 'NUSCENE', 'VOID', 'SUNRGBD', 'TOFDC', 'RGBDD', 'TOFDSR'), help='dataset name')
...
parser.add_argument('--lr', '--learning-rate', default=0.00005, type=float, metavar='LR', help='initial (base) learning rate', dest='lr')#0.002
parser.add_argument('--decay', type=list, default=[40,80,120], help='learning rate decay schedule')#'60,100,150,200'   '80,120,160,200'
parser.add_argument('--gamma', type=str, default='1.0,0.2,0.04,0.008', help='learning rate multiplicative factors')#'1.0,0.5,0.05,0.001'
...
parser.add_argument('--isNosiy', default=0, type=int,
                    help='add Nosiy')
