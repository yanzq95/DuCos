...
from data.rgbdd_dataloader_float import RGBDD_Dataset
from data.tofdsr_dataloader_float import TOFDSR_Dataset
...
def main():
    ...
    val_NYU = NYU_v2_datset(root_dir="/opt/data/private/DSR/datasets/nyu_data/", scale=args.scale,
                            train=False)
